...
- (void)loadData {
    ...
    NSString *type = [NSString stringWithFormat:@"%@",@(_titleTag + 1)];
    
    [ParkTimeModel findObjects:type success:^(NSArray * _Nullable objects, NSError * _Nullable error) {
