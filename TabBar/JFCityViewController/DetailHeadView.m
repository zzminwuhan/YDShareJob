...
- (void)creatBodyView {
    ...
    _label.text = @"热门兼职:";
    _label.font = FONT15;
    _label.textColor = GRAY50;
    [self addSubview:_label];
    
    UILabel *line22 = [[UILabel alloc]initWithFrame:CGRectMake(-15, 30, SCREEM_WIDTH, 0.5)];
    line22.backgroundColor = RGB(200, 200, 200);
    [_label addSubview:line22];
